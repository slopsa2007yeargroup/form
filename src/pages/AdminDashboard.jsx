...

{
        ...
        {loading ? (
          ...
          <div className='px-4'>
            <DataTable
              ...
              subHeader
              subHeaderComponent={
                <div className="w-full flex flex-col md:flex-row justify-between gap-4 overflow-x-auto">
  <div className="flex gap-2 mt-2 overflow-x-auto whitespace-nowrap pb-2">
    <CSVLink 
      data={filteredData}
      filename="form_responses.csv"
      className="px-3 py-1 text-sm rounded-md flex flex-row gap-2 justify-between border border-slate-300 hover:bg-gray-400 hover:text-gray-100 items-center min-w-max"
    >
    <FaFileCsv/>
      Export CSV
    </CSVLink>
  ...
  <form className="w-full md:w-80 my-2">
